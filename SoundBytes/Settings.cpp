...
void SoundBytes::RenderSettings() {
    ...
    // Description, checkbox, and volume
    {
    ...
    // Car hit
    {
        ...
        if (ImGui::IsItemHovered()) {
            ImGui::SetTooltip("Must be exact path with the .extension included!");
        }

        ImGui::TextUnformatted("Minimum speed of ball when hit to play sound");
